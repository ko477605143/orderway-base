 ...
 */
package com.orderway.auth.bus.core.error;

import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.extra.servlet.ServletUtil;
import cn.hutool.log.Log;
import com.orderway.auth.bus.modular.data.HandlerException;
import com.orderway.auth.bus.modular.data.HandlerExceptionEnum;
...
//    }
    ...
    @ResponseBody
    public ErrorResponseData appError(HandlerException e) {
