 ...
 */
package com.orderway.auth.bus.core.filter.security;

import cn.hutool.core.util.IdUtil;
import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.log.Log;
import com.orderway.auth.bus.modular.data.AppHandler;
...
//
//        if(url_str.contains("/handler/app/getToken")) {
//            filterChain.doFilter(request, response);
//            return;
//        }
//
//        String r = appHandler.check_app_token_by_request(request);
//        if(r.equals("2")){//不通过
//            //token过期或者token失效的情况，响应给前端
