 ...
 */
package com.orderway.auth.bus.modular.file.service.impl;
...
import com.orderway.core.consts.MediaTypeConstant;
...
import com.orderway.auth.bus.modular.file.entity.SysFileInfo;
import com.orderway.auth.bus.modular.file.enums.FileLocationEnum;
import com.orderway.auth.bus.modular.file.enums.SysFileInfoExceptionEnum;
import com.orderway.auth.bus.modular.file.mapper.SysFileInfoMapper;
import com.orderway.auth.bus.modular.file.param.SysFileInfoParam;
import com.orderway.auth.bus.modular.file.result.SysFileInfoResult;
import com.orderway.auth.bus.modular.file.service.SysFileInfoService;
import com.orderway.auth.bus.modular.file.util.DownloadUtil;
...
import static com.orderway.auth.bus.config.FileConfig.DEFAULT_BUCKET;
