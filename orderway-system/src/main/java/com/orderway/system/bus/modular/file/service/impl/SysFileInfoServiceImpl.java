 ...
 */
package com.orderway.system.bus.modular.file.service.impl;
...
import com.orderway.system.bus.modular.file.entity.SysFileInfo;
import com.orderway.system.bus.modular.file.enums.FileLocationEnum;
import com.orderway.system.bus.modular.file.enums.SysFileInfoExceptionEnum;
import com.orderway.system.bus.modular.file.mapper.SysFileInfoMapper;
import com.orderway.system.bus.modular.file.param.SysFileInfoParam;
import com.orderway.system.bus.modular.file.result.SysFileInfoResult;
import com.orderway.system.bus.modular.file.service.SysFileInfoService;
import com.orderway.system.bus.modular.file.util.DownloadUtil;
...
import static com.orderway.system.bus.config.FileConfig.DEFAULT_BUCKET;
...
public class SysFileInfoServiceImpl extends ServiceImpl<SysFileInfoMapper, SysFileInfo> implements SysFileInfoService {
    ...
    public Long uploadFile(MultipartFile file) {
        ...
        if (ObjectUtil.isNotEmpty(originalFilename)) {
            // 最后一个参数为ture 返回不包含第二个参数之后的所有字符串（从第一个参数里面找）
