...
public interface SysUserService extends IService<SysUser> {
    ...
    List<Map> sel_user_test();

    List<Map> selMenusByUserIdAndClientType(Map args);

    List<Map> selAppByUserIdAndClientType(Map args);

    /**
     * 判断手机号唯一性。
     *
     * @param phone         手机号
     * @param isExcludeSelf 为true 判断的时候排除自己
     */
    void checkPhone(String phone, Long userId, boolean isExcludeSelf);

    /**
     * 判断账号唯一性
     */
    void checkAccount(String account, Long userId, boolean isExcludeSelf);
}
