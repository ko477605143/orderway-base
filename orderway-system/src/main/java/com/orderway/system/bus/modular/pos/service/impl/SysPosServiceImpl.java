 ...
 */
package com.orderway.system.bus.modular.pos.service.impl;
...
import com.orderway.system.bus.modular.pos.enums.SysPosExceptionEnum;
import com.orderway.system.bus.modular.pos.mapper.SysPosMapper;
...
public class SysPosServiceImpl extends ServiceImpl<SysPosMapper, SysPos> implements SysPosService {
     ...
     */
    @Override
    public List<Map> getUserPos(Long userId) {
        return this.baseMapper.getUserPos(userId);
    }
}
